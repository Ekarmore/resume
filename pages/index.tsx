...
export default function resume() {
  return (
    <div className='p-10 grid grid-cols-8 gap-10 h-screen leading-7'>
      <Head>
        <title> Resume | ekar </title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        {/* <link rel="icon" type='image' href="../public/Avatar.webp" /> */}
      </Head>
      <section className='col-span-2 p-5  flex flex-col flex-wrap items-center'>
      ...
      <article className='col-span-5 p-5'>
        <section>
          ...
          <section className='mb-5' >
            ...
            <div className='p-5'>
              <div className='Stack'>
              <span className='font-sans font-bold mr-3'>前端</span><span>JavaScript,TypeScript,Vue,Nuxt,Vite,React,Next,TailWindCSS,WindiCSS,UnoCSS</span>
              </div>
              <div className='Stack'>
          ...
          <div className='mb-5'>
            ...
            <div className='grid grid-cols-8 gap-10 p-5'>
