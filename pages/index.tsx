      ...
      <article className='md:col-span-6 xl:col-span-5 md:col-start-5 lg:col-start-4 md:p-5 '>
          ...
          <section className='mb-5 ' >
            ...
            <div className='p-5'>
              ...
              <span className='font-sans font-bold'>Nights Watch 工作室</span><span className='ml-2 font-sans font-bold'>前端开发</span>
            </div>
          </section>
          <section className='mb-5' >
          ...
          <div className='text-center mb-5 md:m-0'>
            <a className='text-xs border-b border-dotted border-dark-200 text-gray-500' target='_blank' href="Resume.pdf">PDF版本</a>
          </div>
      </article>
    </div>
  )
